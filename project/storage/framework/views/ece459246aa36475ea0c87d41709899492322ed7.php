<?php $__env->startSection('content'); ?>
  ...
  <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form id="" action="<?php echo e(route('admin-show-store')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <?php echo $__env->make('includes.form-success', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="show_name"  id="showname" placeholder="<?php echo e(__('Show Name')); ?>">
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/videohub/project/resources/views/admin/show/create.blade.php ENDPATH**/ ?>