                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group VideoInsert">
                                        ...
                                        <span class="ml-2 mb-2 d-block d-sm-inline-block"><?php echo e(__('(support (mp4,webm,avi,flv,mkv))'), false); ?></span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zaiflix Project\videohub\project\resources\views/admin/movie/create.blade.php ENDPATH**/ ?>