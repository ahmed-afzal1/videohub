        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php if(request()->routeIs('category.search')): ?>
                        <h4>
                            ...
                            <a href="<?php echo e(route('category.index')); ?>" class="btn btn-primary"><i
                                ...
                                <tr>
                                    ...
                                    <td class="w-25">
                                        <select name="status" class="form-control status"
                                                    data-url="<?php echo e(route('category.status', $category->id)); ?>">
                                    ...
                                    <td>
                                        ...
                                        <button data-href="<?php echo e(route('category.update', $category)); ?>" data-name="<?php echo e($category->name); ?>" class="btn btn-primary edit"><i
                                                class="fa fa-pen"></i></button>
                                        <a href="" data-url="<?php echo e(route('category.destroy', $category)); ?>"
                ...
                <?php if($categories->hasPages()): ?>
                    <?php echo e($categories->links('partials.paginate')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\video\videohub\project\resources\views/admin/category/index.blade.php ENDPATH**/ ?>