    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><?php echo e(__('Create Post')); ?>
        ...
        <a href="<?php echo e(route('admin-blog-index')); ?>" class="btn back-btn btn-sm"><?php echo e(__('Back')); ?></a>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Create Post')); ?></li>
            </ol>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin-blog-store')); ?>" enctype="multipart/form-data" method="POST" id="">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" id="title" placeholder="<?php echo e(__('Blog Title')); ?>">
                            </div>

                            <div class="form-group">
                                <label for="slug"><?php echo e(__('Blog Slug')); ?></label>
                                <input type="text" class="form-control" name="slug" id="slug" placeholder="<?php echo e(__('Blog Slug')); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tag" name="tags" placeholder="<?php echo e(__('Tags')); ?>">
                            </div>

                            
                            <div class="form-group">
                                <label for="description"><?php echo e(__('Description')); ?></label>
                                <textarea id="area1" class="form-control nic-edit" name="description" placeholder="<?php echo e(__('Description')); ?>"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="source"><?php echo e(__('Source')); ?></label>
                                <input type="text" class="form-control" name="source" id="source" placeholder="<?php echo e(__('Source')); ?>">
                            </div>
                            ...
                            <div class="showbox d-none">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_tag" name="meta_tag" placeholder="<?php echo e(__('Meta Tag')); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="meta_description"><?php echo e(__('Description')); ?></label>
                                    <textarea  class="form-control" rows="4" id="meta_description" name="meta_description" placeholder="<?php echo e(__('Meta Description')); ?>"></textarea>
                                </div>
                              </div>
...
<input type="hidden" value="1" id="isValue">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/videohub/project/resources/views/admin/blog/create.blade.php ENDPATH**/ ?>