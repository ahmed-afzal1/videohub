            ...
            <div class="card mb-4">
                <div class="row py-3">
                    ...
                    <div class="col-md-6 text-center video-area <?php echo e($data->video_type == 'file' ? '' : 'd-none'); ?>">
                        <video src="<?php echo e($data->video_type == 'file' ? asset('assets/videos/movie-videos/'.$data->video) : ''); ?>"  width="400" height="360" controls class="<?php echo e($data->video_type == 'file' ? '': 'd-none'); ?>"></video>
                    </div>
                    <div class="col-md-6 text-center url-area <?php echo e($data->video_type == 'url' ? '' : 'd-none'); ?>">
                        <iframe width="400" height="360" src="<?php echo $data->video_type == 'url' ? $data->video : ''; ?>" class="<?php echo e($data->video_type == 'url' ? '': 'd-none'); ?>">
                        </iframe>
                    </div>
                  
                    <div class="col-md-6 image-area <?php echo e($data->image->image != null ? '' : 'd-none'); ?> text-center">
                        <img src="<?php echo e(asset('assets/images/'.$data->image->image)); ?>" class="img-fluid" width="400" height="360" alt="">
                    </div>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('admin.movie.update',$data->id)); ?>" enctype="multipart/form-data" method="POST" id="form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm  mb-3" name="video_type" id="video_type">
                                <option value="file" <?php echo e($data->video_type == 'file' ? 'selected' : ''); ?>><?php echo e(__('File')); ?></option>
                                <option value="url" <?php echo e($data->video_type == 'url' ? 'selected' : ''); ?>><?php echo e(__('Url')); ?></option>
                            </select>
                        </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group VideoInsert">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="video_name" id="video" value="" data-href="<?php echo e(route('admin.movie.processing')); ?>">
                        ...
                        <input type="hidden" value="<?php echo e($data->video_type == 'url' ? $data->video : ''); ?>" id="getId" name="video">
                        <input type="hidden" value="<?php echo e($data->video_type); ?>" id="type">

                        <div class="form-group">
                            <label for="title"><?php echo e(__('Movie Title')); ?></label>
                            <input type="text" class="form-control" name="title" id="title" placeholder="<?php echo e(__('Movie Title')); ?>" value="<?php echo e($data->title); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control date" name="relase_date" placeholder="<?php echo e(__('Realse Date')); ?>" value="<?php echo e(date('d-m-Y', strtotime($data->release_date))); ?>">
                        </div>

                        <div class="form-group">
                            <label for="duration"><?php echo e(__('Duration')); ?></label>
                            <input type="text" class="form-control" name="duration" placeholder="<?php echo e(__('1 hour 30 min')); ?>" value="<?php echo e($data->duration); ?>">
                        </div>

                        <div class="form-group">
                            <label for="tag"><?php echo e(__('Tag')); ?></label>
                            <input type="text" class="form-control" id="tag" name="tag" placeholder="<?php echo e(__('Tag')); ?>" value="<?php echo $data->tag; ?>">
                        </div>

                        <div class="form-group">
                            <label for="description"><?php echo e(__('Description')); ?></label>
                            <textarea id="area1" class="form-control " name="description" placeholder="<?php echo e(__('Description')); ?>"><?php echo $data->description; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label for="producer"><?php echo e(__('Producer')); ?></label>
                            <select class="form-control  mb-3 select-2" id="producer" name="producer[]" multiple="multiple" multiple="multiple">
                                ...
                                <option value="<?php echo e($producer->id); ?>"<?php echo e(in_array($producer->id,$data->producer) ? 'selected': ''); ?>><?php echo e($producer->name); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3 select-2" id="directors" name="directors[]" multiple="multiple" multiple="multiple">
                                ...
                                <option value="<?php echo e($directors->id); ?>" <?php echo e(in_array($directors->id,$data->directors) ? 'selected': ''); ?>><?php echo e($directors->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3 select-2" id="cast" name="cast[]" multiple="multiple" multiple="multiple">
                                ...
                                <option value="<?php echo e($cast->id); ?>"<?php echo e(in_array($cast->id,$data->cast) ? 'selected': ''); ?>><?php echo e($cast->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
var urlHtml = `<label for="url"><?php echo e(__('Video Url')); ?></label>
    ...
    if(showId != ''){
        $.ajax({
			...
			success: function(data){
                let SessionData = '<option value="" selected><?php echo e(__('Select One')); ?></option>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/videohub/project/resources/views/admin/movie/edit.blade.php ENDPATH**/ ?>