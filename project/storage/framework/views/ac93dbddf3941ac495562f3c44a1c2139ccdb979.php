                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $castAndCrews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $castAndCrew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin-cast-crew-edit', $castAndCrew->id), false); ?>" class="btn btn-primary"> <i class="fas fa-pen"></i></a>
                                                <a href="javascript:void(0);" data-href=" <?php echo e(route('admin-cast-crew-delete', $castAndCrew->id), false); ?>" class="btn btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zaiflix Project\videohub\project\resources\views/admin/cast_crew/index.blade.php ENDPATH**/ ?>