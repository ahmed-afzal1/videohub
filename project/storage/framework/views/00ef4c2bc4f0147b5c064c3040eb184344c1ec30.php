                      ...
                      <tbody>
                          <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <td>
                                    <div class="action-list"><a  href="<?php echo e(route('admin-page-edit',$data->id), false); ?>" class="btn btn-primary mr-2"> <i class="fa fa-pen"></i></a><a href="javascript:;" data-href=" <?php echo e(route('admin-page-delete',$data->id), false); ?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></div>
                                 </td>
                            </tr> 
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
              ...
              <button type="submit" class="btn btn-danger btn-ok"><?php echo e(__('Delete'), false); ?></button>
          </div>
