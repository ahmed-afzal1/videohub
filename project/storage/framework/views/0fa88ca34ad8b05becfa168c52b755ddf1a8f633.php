            ...
            <div class="col-lg-12 p-0">
                ...
                <div class="card mb-4">
                    <div class="p-3 admin-video-player-edit-page-wrap">
                        ...
                        <div class="video-area <?php echo e($data->video_type == 'file' ? '' : 'd-none', false); ?>">
                            <video
                        ...
                        <div class="url-area <?php echo e($data->video_type == 'url' ? '' : 'd-none', false); ?>">
                            <iframe width="400" height="360" src="<?php echo $data->video_type == 'url' ? $data->video : ''; ?>"
                                class="<?php echo e($data->video_type == 'url' ? '' : 'd-none', false); ?>">
                            </iframe>
                        </div>

                        <div class="image-area <?php echo e($data->image->image != null ? '' : 'd-none', false); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zaiflix Project\videohub\project\resources\views/admin/episode/edit.blade.php ENDPATH**/ ?>