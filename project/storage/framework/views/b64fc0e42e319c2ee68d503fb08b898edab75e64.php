...
<div class="card mb-4">
  ...
  <div class="card-body">
    ...
    <form id="ModalFormSubmit" action="<?php echo e(route('admin-page-update',$data->id), false); ?>" method="POST">
      <?php echo csrf_field(); ?>
        <div class="form-group">
          <label for="title"><?php echo e(__('Title'), false); ?></label>
        <input type="text" class="form-control" name="title" required id="title" placeholder="<?php echo e(__('Title'), false); ?>" value="<?php echo e($data->title, false); ?>">
        </div>
        <div class="form-group">
          <label for="slug"><?php echo e(__('Slug'), false); ?></label>
        <input type="text" class="form-control" name="slug" required id="slug" placeholder="<?php echo e(__('Slug'), false); ?>" value="<?php echo e($data->slug, false); ?>">
        </div>
        ...
        <div class="form-group">
          ...
          <div class="custom-control custom-checkbox mb-3">
              <input type="checkbox" class="custom-control-input" name="seocheck"  id="customCheck1" <?php echo e($data->meta_tag != null || $data->meta_description != null ? 'checked': '', false); ?>>
              <label class="custom-control-label" for="customCheck1"> <?php echo e(__('Allow Page SEO'), false); ?></label>
            </div>
  
          <div class="meta_description <?php echo e($data->meta_tag != null || $data->meta_description != null ? '': 'd-none', false); ?> mb-3">
              <div class="form-group"> 
                  <label for="meta_tag"><?php echo e(__('Meta Tag'), false); ?></label>
                  <input type="text" class="form-control" name="meta_tag" id="meta_tag" placeholder="<?php echo e(__('Meta Tag'), false); ?>" value="<?php echo e($data->meta_tag, false); ?>">
                </div>
  
              <div class="form-group">
                  <label for="meta_description"><?php echo e(__('Meta Description'), false); ?></label>
                  <input type="text" class="form-control" name="meta_description" id="meta_description" placeholder="<?php echo e(__('Meta Description'), false); ?>" value="<?php echo e($data->meta_description, false); ?>">
                </div>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zaiflix Project\videohub\project\resources\views/admin/page/edit.blade.php ENDPATH**/ ?>