                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="stripe_client_secret" class="form-control"
                                            value="<?php echo e($gateway->gateway_parameters->stripe_client_secret ?? old('stripe_client_secret'), false); ?>">
                                    </div>
                            ...
                            <button type="submit"
                                class="btn btn-primary w-100"><?php echo e(__('Update stripe Information'), false); ?></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\video\videohub\project\resources\views/admin/gateways/stripe.blade.php ENDPATH**/ ?>