                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                      <div class="single-movies">
                        ...
                        <div class="movi-verlay">
                          ...
                          <img class="premium" src="<?php echo e(asset('assets/front/images/premium-label.sv')); ?>g" alt="premium" />
                          <a href="#" class="play-btn"><i class="fas fa-play"></i></a>
                          <div class="share-add-btn">
                            <div class="share-area">
                              <a href="#" class="share-btn"><i class="fas fa-share-alt"></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\videohub\project\resources\views/front/movies.blade.php ENDPATH**/ ?>