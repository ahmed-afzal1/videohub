                        ...
                        <table class="table align-items-center table-flush ">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th width="31%"><?php echo e(__('Action')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $shows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php echo e($show->show_name); ?>

                                        </td>
                                        <td class="w-25">
                                            <img src="<?php echo e($show->image->image ? asset('assets/images/' . $show->image->image) : asset('assets/images/noimages.png')); ?>"
                                                alt="" class="w-25">
                                        </td>
                                        
                                        <td>
                                              <select name="status" class="status form-control" data-url="<?php echo e(route('admin-show-status', $show->id)); ?>" class="form-control">
                                                    <option value="1" <?php echo e($show->status ? 'selected' : ''); ?>><?php echo e(__('Active')); ?></option>
                                                    <option value="0" <?php echo e($show->status ? '' : 'selected'); ?>><?php echo e(__('Inactive')); ?></option>
                                                </select>
                                        </td>
                                        <td>
                                            <div class="action-list"><a href="<?php echo e(route('admin-show-edit', $show->id)); ?>"
                                                    class="btn btn-primary btn-sm mr-2"> <i
                                                        class="fas fa-edit mr-1"></i><?php echo e(__('Edit')); ?></a><a
                                                    href="javascript:;"
                                                    data-href=" <?php echo e(route('admin-show-delete', $show->id)); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\video\videohub\project\resources\views/admin/show/index.blade.php ENDPATH**/ ?>