                    ...
                    <div class="movie-details-left">
                        <div class="playerContainer">
                            ...
                            <video id="my-video" class="video-js vjs-big-play-centered" controls
                                poster="<?php echo e(asset('assets/images/' . $movie->image->image), false); ?>" data-setup="{}">
                                <source src="<?php echo e($movie->vedio, false); ?>" type="video/mp4">
                        ...
                        <div class="movie-details-info">
                            <div class="info-top">
                                <div class="info-top-left">
                                    <h2><?php echo e($movie->title, false); ?>

                                        <span>(<?php echo e(Carbon\Carbon::parse($movie->relase_date)->format('Y'), false); ?>)</span>
                                    </h2>
                                </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="single-cast">
                                            <div class="cast-image">
                                                ...
                                                <a href="#"><img src="<?php echo e(asset('assets/images/'.$cast->image->image), false); ?>"
                                                        alt="cast" /></a>
                                            </div>
                                            <div class="cast-info">
                                                <h4><a href="#"><?php echo e($cast->name, false); ?></a></h4>
