...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800"><?php echo e(__('Create')); ?> <a href="<?php echo e(route('admin-page-index')); ?>" class="btn back-btn btn-sm"><?php echo e(__('Back')); ?></a></h1>    
  <ol class="breadcrumb">
  ...
  <div class="card-body">
    ...
    <form action="<?php echo e(route('admin-page-store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
        ...
        <input type="text" class="form-control" name="title" required id="title" placeholder="<?php echo e(__('Title')); ?>" value="">
        </div>
        <div class="form-group">
          <label for="slug"><?php echo e(__('Slug')); ?></label>
        <input type="text" class="form-control" name="slug" required id="slug" placeholder="<?php echo e(__('Slug')); ?>" value="">
        </div>
        ...
        <div class="form-group">
          ...
          <div class="meta_description d-none }} mb-3">
              <div class="form-group"> 
                  ...
                  <input type="text" class="form-control" name="meta_tag" id="meta_tag" placeholder="<?php echo e(__('Meta Tag')); ?>" value="">
                </div>
  
              <div class="form-group">
                  <label for="meta_description"><?php echo e(__('Meta Description')); ?></label>
                  <input type="text" class="form-control" name="meta_description" id="meta_description" placeholder="<?php echo e(__('Meta Description')); ?>" value="">
                </div>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/videohub/project/resources/views/admin/page/create.blade.php ENDPATH**/ ?>