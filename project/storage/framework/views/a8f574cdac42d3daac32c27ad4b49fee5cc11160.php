<?php $__env->startSection('content'); ?>
  ...
  <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo e(route('admin-cast-crew-update',$data->id)); ?>" enctype="multipart/form-data" method="POST">
          <?php echo csrf_field(); ?>
          <?php echo $__env->make('includes.form-success', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          <div class="form-group">
            <label for="name"><?php echo e(__('Name')); ?></label>
            <input type="text" class="form-control" name="name" value="<?php echo e($data->name); ?>" id="name" placeholder="<?php echo e(__('Name')); ?>">
          </div>
        ...
        <div class="form-group ShowLanguageImage <?php echo e($data->image->image ? '' : 'd-none'); ?>">
            <img src="<?php echo e($data->image->image ? asset('assets/images/'.$data->image->image) : ''); ?>" alt="image" width="150">
        </div>
     
    
          <div class="form-group">
            <label for="bio"><?php echo e(__('Bio')); ?></label>
            <textarea name="bio" id="bio" class="form-control"  rows="5" placeholder="<?php echo e(__('Enter Bio')); ?>"><?php echo e($data->bio); ?></textarea>
          </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/videohub/project/resources/views/admin/cast_crew/edit.blade.php ENDPATH**/ ?>