                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group mb-5">
                                    <label class="col-form-label"><?php echo e(__('Stripe Image'), false); ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form_control currency" name="rate"
                                                value="<?php echo e(number_format($gateway->rate, 4) ?? 0, false); ?>">
                                    ...
                                    <div class="form-group col-md-4 col-12">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option value="1" <?php echo e(@$gateway->status ? 'selected' : '', false); ?>>
                                                <?php echo e(__('Yes'), false); ?>

                                            </option>
                                            <option value="0" <?php echo e(@$gateway->status ? '' : 'selected', false); ?>>
                                                <?php echo e(__('No'), false); ?></option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for=""><?php echo e(__('Stripe Publishable Key'), false); ?></label>
                                        <input type="text" name="stripe_client_id" class="form-control"
                                            value="<?php echo e($gateway->gateway_parameters->stripe_client_id ?? old('stripe_client_id'), false); ?>">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for=""><?php echo e(__('Stripe Secret Key'), false); ?></label>
                                        <input type="text" name="stripe_client_secret" class="form-control" value="<?php echo e($gateway->gateway_parameters->stripe_client_secret ?? old('stripe_client_secret'), false); ?>">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <button type="submit" class="btn btn-primary w-100"><?php echo e(__('Update stripe Information'), false); ?></button>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zaiflix Project\videohub\project\resources\views/admin/gateways/stripe.blade.php ENDPATH**/ ?>