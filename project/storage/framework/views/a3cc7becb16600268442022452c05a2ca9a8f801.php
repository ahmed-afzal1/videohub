    ...
    <section class="register-area" style="background-image: url(<?php echo e(asset('assets/front/images/register-bg.jpg')); ?>);">
      <div class="register-wrap">
        <div class="register-top">
          ...
          <p>Already have an account? <a href="<?php echo e(route('user.login')); ?>">Login</a></p>
        </div>
...
</html><?php /**PATH D:\xampp\htdocs\video\videohub\project\resources\views/user/register.blade.php ENDPATH**/ ?>