<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin-show-store'), false); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="show_name" id="showname"
                            placeholder="<?php echo e(__('Show Name'), false); ?>">
                    </div>
 
                    <div class="form-group col-md-6">
                        <label for="date"><?php echo e(__('Realse Date'), false); ?></label>
                        <input type="text" class="form-control date" name="relase_date"
                            placeholder="<?php echo e(__('Realse Date'), false); ?>" id="datepicker" autocomplete="off">
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zaiflix Project\videohub\project\resources\views/admin/show/create.blade.php ENDPATH**/ ?>