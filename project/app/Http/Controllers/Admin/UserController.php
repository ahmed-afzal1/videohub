	    ...
	    public function datatables()
	    {
	         ...
	         return DataTables::of($datas)
	                            ->editColumn('photo', function(User $data) {
									$image = $data->photo != null ? url('assets/images/user-image/'.$data->photo):url('assets/images/noimage.png');
									return '<img src="' . $image . '" alt="Image" width="100">';
	                            }) 
								->addColumn('action', function(User $data) {
									return '<div class="action-list"><a href="javascript:;" data-href="' . route('admin-user-edit',$data->id) . '" class="btn btn-primary btn-sm mr-2 edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit mr-1"></i>'. __('Edit') .'</a><a href="' . route('admin-user-show',$data->id) . '" class="btn btn-info btn-sm mr-2 "> <i class="fas fa-edit mr-1"></i>'. __('Details') .'</a><a href="javascript:;" data-href="' . route('admin-user-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a></div>';
								})
