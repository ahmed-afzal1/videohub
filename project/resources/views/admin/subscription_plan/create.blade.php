...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
   <h1 class="h3 mb-0 text-gray-800">{{ __('Create') }} <a href="{{ route('admin-subscription-plan-index') }}" class="btn back-btn btn-sm">{{__('Back')}}</a></h1>
   <ol class="breadcrumb">
   ...
   <div class="card-body">
      ...
      <form id="" action="{{route('admin-subscription-plan-store')}}" method="POST">
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" name="plan_name" required id="plan_name" placeholder="{{ __('Plan Name') }}" >
         </div>
         <div class="form-group">
            <label for="price">{{ __('Plan Price') }}</label>
            <input type="text" class="form-control" name="price" required id="price" placeholder="{{ __('Plan Price') }}" >
         </div>
         <div class="form-group">
          ...
          <div class="feature-area mt-5 position-relative">
            ...
            <div class="row">
               <div class="col-sm-6 col-md-6 col-6">
                  <div class="form-group">
                     <input type="text" class="form-control" name="feature_key[]" placeholder="{{__('Enter Feature Name')}}" id="">
                  </div>
               </div>
               <div class="col-sm-6 col-md-6 col-6">
                  <div class="form-group">
