            ...
            <div class="card mb-4">
                <div class="row py-3">
                    ...
                    <div class="col-md-6 text-center video-area {{ $data->video_type == 'file' ? '' : 'd-none' }}">
                        <video src="{{ $data->video_type == 'file' ? asset('assets/videos/movie-videos/'.$data->video) : '' }}"  width="400" height="360" controls class="{{ $data->video_type == 'file' ? '': 'd-none' }}"></video>
                    </div>
                    ...
                    <div class="col-md-6 image-area {{ $data->image->image != null ? '' : 'd-none' }} text-center">
                        <img src="{{ asset('assets/images/'.$data->image->image) }}" class="img-fluid" width="400" height="360" alt="">
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.movie.update',$data->id)}}" enctype="multipart/form-data" method="POST" id="form">
                        @csrf
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group VideoInsert">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="video_name" id="video" value="" data-href="{{route('admin.movie.processing')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3 select-2" id="producer" name="producer[]" multiple="multiple" multiple="multiple">
                                ...
                                <option value="{{$producer->id}}"{{ in_array($producer->id,$data->producer) ? 'selected': '' }}>{{$producer->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3 select-2" id="directors" name="directors[]" multiple="multiple" multiple="multiple">
                                ...
                                <option value="{{$directors->id}}" {{ in_array($directors->id,$data->directors) ? 'selected': '' }}>{{$directors->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3 select-2" id="cast" name="cast[]" multiple="multiple" multiple="multiple">
                                ...
                                <option value="{{$cast->id}}"{{ in_array($cast->id,$data->cast) ? 'selected': '' }}>{{$cast->name}}</option>
                                @endforeach
                            </select>
                        </div>
