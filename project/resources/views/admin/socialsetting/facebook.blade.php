          ...
          <form id="pageForm" action="{{ route('admin-social-update-all') }}" enctype="multipart/form-data" method="POST">@csrf
             @include('includes.admin.form-both')
              ...
              <div class="form-group row mb-5">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" id="website_url" name="fclient_secret" placeholder="{{ __('Website URL') }}" value="{{url('/')}}">
                  </div>
              </div>
              ...
              <div class="form-group row mb-5">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" id="fredirect" name="fclient_secret" placeholder="{{ __('Valid OAuth Redirect URI') }}" value="{{$data->fclient_secret}}">
                  </div>
              </div>
