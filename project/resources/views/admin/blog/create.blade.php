            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin-blog-store')}}" enctype="multipart/form-data" method="POST" id="">
                            @csrf
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slug" id="slug" placeholder="{{ __('Blog Slug') }}">
                            </div>
