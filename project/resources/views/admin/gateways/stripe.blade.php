                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="stripe_client_secret" class="form-control" value="{{ $gateway->gateway_parameters->stripe_client_secret ?? old('stripe_client_secret') }}">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <button type="submit" class="btn btn-primary w-100">{{ __('Update stripe Information') }}</button>
                                    </div>
                                </div>
                            </div>
