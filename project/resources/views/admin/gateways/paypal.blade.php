                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                       ...
                                       <select name="mode" id="" class="form-control">
                                        <option value="sandbox" {{@$gateway->gateway_parameters->mode == 'sandbox' ? 'selected' : ''}}>{{__('Sandbox')}}</option>
                                        <option value="live" {{@$gateway->gateway_parameters->mode == 'live' ? 'selected' : ''}}>{{__('Live')}}</option>
                                       </select>
                                    </div>
