          ...
          <div class="table-responsive p-3">
            ...
            <table id="geniustable" class="table align-items-center table-flush  dt-responsive">
              ...
              <tbody>
                ...
                <td>{{$data->access}}</td>
                <td>
                  <div class="action-list"><a  href="{{route('admin-episode-edit',$data->id) }}" class="btn btn-primary btn-sm mr-2"> <i class="fas fa-edit mr-1"></i>{{__('Edit')}}</a><a href="javascript:;" data-href=" {{route('admin-episode-delete',$data->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a></div>
              </td>
                </tr>
                @endforeach
              </tbody>
