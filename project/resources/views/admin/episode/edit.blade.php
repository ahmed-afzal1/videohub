            ...
            <div class="card mb-4">
                <div class="row py-3">
                    ...
                    <div class="col-md-6 text-center video-area {{ $data->video_type == 'file' ? '' : 'd-none' }}">
                        <video src="{{ $data->video_type == 'file' ? asset('assets/videos/episode-videos/'.$data->video) : '' }}"  width="400" height="360" controls class="{{ $data->video_type == 'file' ? '': 'd-none' }}"></video>
                    </div>
                    ...
                    <div class="col-md-6 image-area {{ $data->image->image != null ? '' : 'd-none' }} text-center">
                        <img src="{{ asset('assets/images/episode-image/'.$data->image->image) }}" class="img-fluid" width="400" height="360" alt="">
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{route('admin-episode-update',$data->id)}}" enctype="multipart/form-data" method="POST" id="form">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3" name="tv_show_id" id="TvShow" >
                                ...
                                <option value="{{$item->id}}" {{ $data->tv_show_id == $item->id ? 'selected' : '' }}>{{$item->show_name}}</option>
                                @endforeach
                            </select>
                        </div>
