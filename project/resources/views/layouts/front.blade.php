      ...
      <div class="header-wrap">
          <div class="container">
              <nav class="navbar navbar-expand-xl navbar-light">
                  <a class="navbar-brand" href="{{route('front.index')}}"><img src="{{asset('assets/front/images/logo.png')}}" alt="ZaiFlix" /></a>
                          ...
                          <div class="mega-menu">
                            <div class="d-flex align-items-start">
                              <div class="nav nav-pills flex-column me-4" id="Movies-tab" role="tablist" aria-orientation="vertical">
                                <button class="nav-link active" id="Movies-ZaiflixPremium-tab" data-bs-toggle="pill" data-bs-target="#Movies-ZaiflixPremium" type="button" role="tab" aria-controls="Movies-ZaiflixPremium" aria-selected="true">{{__('Zaiflix Premium')}}</button>
                                <button class="nav-link" id="Movies-TrendingMovies-tab" data-bs-toggle="pill" data-bs-target="#Movies-TrendingMovies" type="button" role="tab" aria-controls="Movies-TrendingMovies" aria-selected="false">{{__('Trending Movies')}}</button>
                                <button class="nav-link" id="Movies-TopRated-tab" data-bs-toggle="pill" data-bs-target="#Movies-TopRated" type="button" role="tab" aria-controls="Movies-TopRated" aria-selected="false">{{__('Top Rated')}}</button>
                                <button class="nav-link" id="Movies-LatestZaiflix-tab" data-bs-toggle="pill" data-bs-target="#Movies-LatestZaiflix" type="button" role="tab" aria-controls="Movies-LatestZaiflix" aria-selected="false">{{__('Latest on Zaiflix')}}</button>
                                <button class="nav-link" id="Movies-ZaiflixOriginals-tab" data-bs-toggle="pill" data-bs-target="#Movies-ZaiflixOriginals" type="button" role="tab" aria-controls="Movies-ZaiflixOriginals" aria-selected="false">{{__('Zaiflix Originals')}}</button>
                              </div>
                                ...
                                <div class="tab-pane fade show active" id="Movies-ZaiflixPremium" role="tabpanel" aria-labelledby="Movies-ZaiflixPremium-tab">
                                  <div class="movies-list">
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item1.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item2.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item3.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item4.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item5.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item6.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item7.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item8.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item9.png')}}" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="Movies-LatestZaiflix" role="tabpanel" aria-labelledby="Movies-LatestZaiflix-tab">
                                  <div class="movies-list">
                                    ...
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item2.pn')}}g" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                          ...
                          <div class="mega-menu">
                            <div class="d-flex align-items-start">
                              <div class="nav nav-pills flex-column me-4" id="Series-tab" role="tablist" aria-orientation="vertical">
                                <button class="nav-link active" id="Series-ZaiflixPremium-tab" data-bs-toggle="pill" data-bs-target="#Series-ZaiflixPremium" type="button" role="tab" aria-controls="Series-ZaiflixPremium" aria-selected="true">{{__('Zaiflix Premium')}}</button>
                                <button class="nav-link" id="Series-TrendingMovies-tab" data-bs-toggle="pill" data-bs-target="#Series-TrendingMovies" type="button" role="tab" aria-controls="Series-TrendingMovies" aria-selected="false">{{__('Trending Movies')}}</button>
                                <button class="nav-link" id="Series-TopRated-tab" data-bs-toggle="pill" data-bs-target="#Series-TopRated" type="button" role="tab" aria-controls="Series-TopRated" aria-selected="false">{{__('Top Rated')}}</button>
                                <button class="nav-link" id="Series-LatestZaiflix-tab" data-bs-toggle="pill" data-bs-target="#Series-LatestZaiflix" type="button" role="tab" aria-controls="Series-LatestZaiflix" aria-selected="false">{{__('Latest on Zaiflix')}}</button>
                                <button class="nav-link" id="Series-ZaiflixOriginals-tab" data-bs-toggle="pill" data-bs-target="#Series-ZaiflixOriginals" type="button" role="tab" aria-controls="Series-ZaiflixOriginals" aria-selected="false">{{__('Zaiflix Originals')}}</button>
                              </div>
                          ...
                          <div class="mega-menu">
                            <div class="d-flex align-items-start">
                              <div class="nav nav-pills flex-column me-4" id="Kids-tab" role="tablist" aria-orientation="vertical">
                                <button class="nav-link active" id="Kids-ZaiflixPremium-tab" data-bs-toggle="pill" data-bs-target="#Kids-ZaiflixPremium" type="button" role="tab" aria-controls="Kids-ZaiflixPremium" aria-selected="true">{{__('Zaiflix Premium')}}</button>
                                <button class="nav-link" id="Kids-TrendingMovies-tab" data-bs-toggle="pill" data-bs-target="#Kids-TrendingMovies" type="button" role="tab" aria-controls="Kids-TrendingMovies" aria-selected="false">{{__('Trending Movies')}}</button>
                                <button class="nav-link" id="Kids-TopRated-tab" data-bs-toggle="pill" data-bs-target="#Kids-TopRated" type="button" role="tab" aria-controls="Kids-TopRated" aria-selected="false">{{__('Top Rated')}}</button>
                                <button class="nav-link" id="Kids-LatestZaiflix-tab" data-bs-toggle="pill" data-bs-target="#Kids-LatestZaiflix" type="button" role="tab" aria-controls="Kids-LatestZaiflix" aria-selected="false">{{__('Latest on Zaiflix')}}</button>
                                <button class="nav-link" id="Kids-ZaiflixOriginals-tab" data-bs-toggle="pill" data-bs-target="#Kids-ZaiflixOriginals" type="button" role="tab" aria-controls="Kids-ZaiflixOriginals" aria-selected="false">{{__('Zaiflix Originals')}}</button>
                              </div>
                                ...
                                <div class="tab-pane fade" id="Kids-ZaiflixOriginals" role="tabpanel" aria-labelledby="Kids-ZaiflixOriginals-tab">
                                  <div class="movies-list">
                                    ...
                                    <div class="single-movi">
                                      <a href="#">
                                        <div class="movi-thumbnail">
                                          <img class="poster-image" src="{{asset('assets/front/images/megamenu-item9.pn')}}g" alt="movi name" />
                                          <div class="premium-icon"><img src="{{asset('assets/front/images/premium.svg')}}" alt="premium" /></div>
                                        </div>
                                      </a>
                                    </div>
                      ...
                      <div class="header-right d-flex align-items-center">
                          ...
                          <div class="dropdown language-dropdown">
                              <button class="language-btn" data-bs-toggle="dropdown" >
                                  <img class="flag" src="{{asset('assets/front/images/usa-flag.png')}}" alt="usa" />
  ...
  <!-- header area end here  -->
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileoffcanvas">
      <div class="offcanvas-header">
        <a class="navbar-brand" href="index.html"><img src="{{asset('assets/front/images/logo.png')}}" alt="ZaiFlix" /></a>
        ...
        <div class="button-list d-flex align-items-center justify-content-center">
          ...
          <div class="dropdown favourite-dropdown">
            <button class="favourite-btn" data-bs-toggle="dropdown" >
                <img class="favourite" src="{{asset('assets/front/images/favourite.svg')}}" alt="favourite" />
            </button>
                ...
                <li>
                  <a href="#" class="singtle-movi">
                    <div class="movi-image">
                      <img src="{{asset('assets/front/images/favourite-1.png')}}" alt="favourite" />
                    </div>
                    <div class="movi-info">
          ...
          <div class="row">
            <div class="col-xl-6 col-lg-3 col-md-6 col-sm-6">
              <div class="single-widget about-widget">
                <a href="index.html" class="brand-logo"><img src="{{asset('assets/front/images/logo.png')}}" alt="logo" /></a>
