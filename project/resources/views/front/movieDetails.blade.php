              ...
              <div class="movie-details-left">
                <div class="playerContainer">
                  <video class="xdPlayer"  preload="auto">
                    <source src="{{asset('assets/front/videos/test.mp4')}}"  type="video/mp4" />
                ...
                <div class="movie-details-info">
                  <div class="info-top">
                    ...
                    <div class="info-top-right">
                      <a class="share-btn" href="#"><img src="{{asset('assets/front/images/share.svg')}}" alt="share" /></a>
                      <a class="add-list-btn" href="#">+ Add to List</a>
                    </div>
                  </div>
                  <ul class="movie-meta">
                    <li><img class="meta-icon" src="{{asset('assets/front/images/clock.svg')}}" alt="clock"> <span>167min</span></li>
                    <li><img class="meta-icon" src="{{asset('assets/front/images/video.svg')}}" alt="clock"> <span>1080p</span></li>
                    <li><img class="meta-icon" src="{{asset('assets/front/images/calendar.svg')}}" alt="clock"> <span>2018</span></li>
                  </ul>
                ...
                <div class="cast-area">
                  ...
                  <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                      <div class="single-cast">
                        <div class="cast-image">
                          <a href="#"><img src="{{asset('assets/front/images/cast-1.png')}}" alt="cast" /></a>
                        </div>
                        <div class="cast-info">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                      <div class="single-cast">
                        <div class="cast-image">
                          <a href="#"><img src="{{asset('assets/front/images/cast-2.png')}}" alt="cast" /></a>
                        </div>
                        <div class="cast-info">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                      <div class="single-cast">
                        <div class="cast-image">
                          <a href="#"><img src="{{asset('assets/front/images/cast-3.png')}}" alt="cast" /></a>
                        </div>
                        <div class="cast-info">
